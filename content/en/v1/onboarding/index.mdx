...
gantt
    ...
    Setup                     :sc1, 2025-03-30, 7d
    Testes e Validação        :sc2, after sc1, 28d

    section Recomendação Inteligente
    Setup                     :ri1, 2025-04-27, 7d
    Testes e Validação        :ri2, after ri1, 28d
```
...
| Simulação de Cenários | Setup | 21/04 | 27/04 | 1 semana |
| | Testes e Validação | 28/04 | 25/05 | 4 semanas |
| Recomendação Inteligente | Setup | 26/05 | 01/06 | 1 semana |
| | Testes e Validação | 02/06 | 29/06 | 4 semanas |
...
**Testes e Validação** *(semanas 4-5)*
- [ ] Apresentação e iteração com a Torre de Tráfego
- [ ] Validação do funcionamento com a equipe operacional
